...
export default {
  ...
  resume: {
    enabled: true,
    pdfUrl: "/MohammedRazinResume1.pdf" // add files in static folder
  },
  uses: {
    enabled: false,
    meta: [
  ...
  workedAt: {
    ...
    meta: [
      {
        name: "TeqBuddies",
        src: "/images/teqbuddies.jpg",
        url: "http://www.teqbuddies.com/"
      },
      {
        name: "Elision Tec",
        src: "/images/elision-logo.jpg",
        url: "https://www.elisiontec.com/"
      }
  ...
  strings: {
    en_US: {
      ...
      hero: {
        ...
        description:
          "I'm a Full Stack Web Developer with 2+ years of experience in development of Web Based applications with excellent programming.",
        words: ["developer"]
      },
      githubCalendar: {
